  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-4 flex flex-col items-center">
      <div className="w-full flex items-center justify-between relative font-sans">
        {/* Connecting Line */}
        <div className="absolute left-6 right-6 top-4.5 h-[2px] bg-slate-200 dark:bg-slate-700 -z-0" />
            ...
            >
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center font-bold text-xs transition-all duration-200 border-2 ${
                  isCurrent
                    ? 'bg-primary-gradient text-white border-transparent shadow-md shadow-primary-gradient ring-4 ring-blue-100 dark:ring-blue-500/20 scale-110'
                    : isCompleted
                    ? 'bg-white dark:bg-[#111827] text-[#2563EB] dark:text-blue-400 border-[#2563EB] dark:border-blue-500 shadow-xs hover:bg-blue-50 dark:hover:bg-blue-950/40'
                    : 'bg-white dark:bg-[#0B1120] text-slate-400 dark:text-slate-500 border-slate-300 dark:border-slate-700 hover:border-slate-400 dark:hover:border-slate-600'
                }`}
              >
                {isMastered ? (
          ...
          <div
            className={`w-9 h-9 rounded-full flex items-center justify-center font-bold text-xs transition-all duration-200 border-2 ${
              isLevel6Active
                ...
                : 'bg-slate-100 dark:bg-[#0B1120] text-slate-400 dark:text-slate-500 border-slate-300 dark:border-slate-700'
            }`}
          >
            {isAllQuestCompleted ? (
