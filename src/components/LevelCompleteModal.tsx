  ...
  useEffect(() => {
    try {
      confetti({
        ...
        spread: 60,
        origin: { y: 0.6 },
        colors: ['#1D4ED8', '#2563EB', '#6366F1', '#10B981'],
      });
    } catch {
      // Ignore
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-editorial-fade font-sans">
      <div className="bg-white dark:bg-[#111827] w-full max-w-md border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl dark:shadow-[0_0_30px_rgba(37,99,235,0.25)] overflow-hidden p-6 sm:p-8 flex flex-col items-center text-center">
        {/* Victory Icon */}
        <div className="w-14 h-14 rounded-2xl bg-primary-gradient text-white flex items-center justify-center mb-3 shadow-md shadow-primary-gradient">
          <Award className="w-8 h-8 text-white" />
        </div>

        <span className="text-[11px] font-bold font-mono uppercase tracking-widest text-[#2563EB] dark:text-blue-300 bg-blue-50 dark:bg-blue-950/60 px-3 py-1 rounded-md border border-blue-100 dark:border-blue-900/40 mb-2">
        ...
        <div className="my-4 p-4 bg-slate-50 dark:bg-[#0B1120] border border-slate-200 dark:border-slate-800 rounded-xl w-full text-left">
          ...
          <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs font-mono">
            ...
            <span className="font-bold text-[#2563EB] dark:text-blue-300 bg-white dark:bg-[#111827] px-2.5 py-1 rounded-md border border-slate-200 dark:border-slate-800">
